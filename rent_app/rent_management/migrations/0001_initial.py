    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_last', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('available', 'Available'), ('under service', 'Under Service'), ('unavailable', 'Unavailable'), ('sold out', 'Sold Out')], default='available', max_length=15)),
                ...
                ('rent', models.DecimalField(decimal_places=2, default=0.0, max_digits=7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lease_start_date', models.DateField(default=datetime.datetime(2024, 3, 18, 23, 36, 9, 371971, tzinfo=datetime.timezone.utc))),
                ('lease_end_date', models.DateField(default=datetime.datetime(2024, 4, 17, 23, 36, 9, 371971, tzinfo=datetime.timezone.utc))),
